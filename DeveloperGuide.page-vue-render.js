...
with(this){return _c('p',[_v("The "),_c('em',[_v("Sequence Diagram")]),_v(" below shows how the components interact with each other for the scenario where the user issues the command "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delc 1")]),_v(".")])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"add-client"}},[_v("Add Client"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#add-client","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addc")]),_v(" command adds a client from WealthVault based on the specified index.")])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"add-policy"}},[_v("Add Policy"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#add-policy","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addp")]),_v(" command adds a policy (tag) to a client's list of policies.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("The Class Diagram of a Client can be "),_c('a',{attrs:{"href":"#model-component"}},[_v("seen in the diagram above")]),_v(".")])}
},function anonymous(
...
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addp")]),_v(" command adds a policy to the client at the given index.\nThe following sequence diagrams illustrate how this process flows through the logic component:")])}
},function anonymous(
) {
with(this){return _c('p',[_v("As seen above, the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("execute")]),_v(" method adds the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Policy")]),_v(" to the client at the specified index. If the index is invalid, an error is thrown.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Aspect: How to specify multiple indices:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("Alternative 1 (current choice):")]),_v(" Use "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("i/")]),_v(" prefix for each index")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Clear and explicit format, reduces input errors")]),_v(" "),_c('li',[_v("Cons: Slightly more verbose")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Alternative 2:")]),_v(" Use space-separated indices")]),_v(" "),_c('ul',[_c('li',[_v("Pros: More concise")]),_v(" "),_c('li',[_v("Cons: Higher chance of input errors, less explicit")])])])])}
},function anonymous(
) {
...
with(this){return _c('h4',{attrs:{"id":"priority-tag"}},[_v("Priority Tag"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#priority-tag","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("The priority command is built around the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("PriorityTag")]),_v(" class, which extends "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Tag")]),_v(".\nThe PriorityTag constructor does not accept arguments, ensuring that its tagName\nis always set to \"Priority.\"")])}
},function anonymous(
) {
with(this){return _c('p',[_v("The Class Diagram of a Client can be "),_c('a',{attrs:{"href":"#model-component"}},[_v("seen in the diagram above")]),_v(".")])}
},function anonymous(
...
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("PriorityCommand")]),_v(" toggles a client’s priority status. The following sequence diagrams\nillustrate how this process flows through the logic component:")])}
},function anonymous(
) {
with(this){return _c('p',[_v("The following sequence diagrams illustrate how the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("PriorityCommand")]),_v(" class interacts with\nmodel components to toggle the priority of the user")])}
},function anonymous(
) {
with(this){return _c('p',[_v("As seen above, the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("togglePriority")]),_v(" method creates a new "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Client")]),_v(" object\nwith updated priority. If the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Client")]),_v(" does not have a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("PriorityTag")]),_v(",\n"),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("togglePriority")]),_v(" will create a new "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Client")]),_v(" with a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("PriorityTag")]),_v(" object.\nElse, it will filter the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("PriorityTag")]),_v(" out of "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("tags")]),_v(".\nIts operation is modeled below:")])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"find-any-find-all"}},[_v("Find-Any Find-All"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#find-any-find-all","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("As the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("findany")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("findall")]),_v(" command performs very similarly. We thought that it made\nthe most sense for "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("FindClientOrCommand")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("FindClientAndClient")]),_v(" to be sibling classes\n(in this case extending from "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AbstractFindClientCommand")]),_v("). The main difference between\nthe two is that they use different predicates "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ContainsAnyKeywordsPredicate")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ContainsAnyKeywordsPredicate")]),_v("\nwhich inherits from "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AbstractContainsKeywordsPredicate")]),_v("\nBelow is a class diagram to demonstrate the relationship of the 3 classes.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("The following sequence diagram illustrates how the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AbstractFindClientCommand")]),_v(" and hence the\n"),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("FindClientOrCommand")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("FindClientAndCommand")]),_v(" class interacts with"),_c('br'),_v("\nmodel components to get a filtered list from WealthVault:")])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"update-client-feature"}},[_v("Update Client feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#update-client-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("update")]),_v(" command allows users to modify only the contact information (phone, email, address) of a client, without changing their name or tags.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("update")]),_v(" command updates a client's contact information at a given index. Unlike the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit")]),_v(" command which allows changing all client fields, the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("update")]),_v(" command is specifically designed to only modify contact information fields (phone, email, address), preserving the client's name and tags.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("UpdateClientCommand")]),_v(" extends "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Command")]),_v(" directly, rather than extending "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EditCommand")]),_v(", to enforce these restrictions. However, it still reuses the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EditClientDescriptor")]),_v(" class to store field values.")])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("In the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("UpdateClientCommandParser")]),_v(":")]),_v(" "),_c('pre',[_c('code',{pre:true,attrs:{"class":"hljs java"}},[_c('span',[_c('span',{pre:true,attrs:{"class":"hljs-comment"}},[_v("// Only tokenize phone, email, and address prefixes")]),_v("\n")]),_c('span',[_v("ArgumentMultimap argMultimap = ArgumentTokenizer.tokenize(args,\n")]),_c('span',[_v("        PREFIX_PHONE, PREFIX_EMAIL, PREFIX_ADDRESS);\n")])])])]),_v(" "),_c('li',[_c('p',[_v("In the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("createUpdatedClient")]),_v(" method of "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("UpdateClientCommand")]),_v(":")]),_v(" "),_c('pre',[_c('code',{pre:true,attrs:{"class":"hljs java"}},[_c('span',[_c('span',{pre:true,attrs:{"class":"hljs-keyword"}},[_v("return")]),_v(" "),_c('span',{pre:true,attrs:{"class":"hljs-keyword"}},[_v("new")]),_v(" Client(\n")]),_c('span',[_v("        clientToUpdate.getName(),      "),_c('span',{pre:true,attrs:{"class":"hljs-comment"}},[_v("// Preserve original name")]),_v("\n")]),_c('span',[_v("        updatedPhone,\n")]),_c('span',[_v("        updatedEmail,\n")]),_c('span',[_v("        updatedAddress,\n")]),_c('span',[_v("        clientToUpdate.getTags()       "),_c('span',{pre:true,attrs:{"class":"hljs-comment"}},[_v("// Preserve original tags")]),_v("\n")]),_c('span',[_v(");\n")])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"sort-priority-feature"}},[_v("Sort Priority feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#sort-priority-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("SortPriorityCommand")]),_v(" extends the abstract "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Command")]),_v(" class and works with the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" component to sort clients.\nWhen executed, it calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#sortClientsByPriority()")]),_v(" which internally uses the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("UniqueClientList")]),_v(" to sort clients\nbased on their priority status.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("The sorting is implemented in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("UniqueClientList")]),_v(" class, where clients with priority (those with a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("PriorityTag")]),_v(")\nare placed before non-priority clients. This is achieved through a comparator that sorts based on the client's\n"),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("getPriority()")]),_v(" value.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("The command returns a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CommandResult")]),_v(" with a success message once the sorting is complete, and the UI automatically\nupdates to show the new sorted order of clients.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Note:")]),_v(" WealthVault will be referred to generically as Address Book in this section.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Target user profile")]),_v(": Financial advisors")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Managing a significant number of client contacts")]),_v(" "),_c('li',[_v("Requires a one-stop platform to track and update client's financial details")]),_v(" "),_c('li',[_v("Experiences difficulties to keep track of client's financial needs across multiple platforms")]),_v(" "),_c('li',[_v("Easy-to-use, fast and organized interface to maintain efficiency in their work")]),_v(" "),_c('li',[_v("Keen to provide fast and efficient service to customers")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Value proposition")]),_v(": Manage clients and their financial needs faster than a typical mouse/GUI driven app")])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("Financial Advisor")]),_v(" "),_c('td',[_v("Add a new client with contact details")]),_v(" "),_c('td',[_v("Keep track of my clients")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("Financial Advisor")]),_v(" "),_c('td',[_v("Read client’s contact details")]),_v(" "),_c('td',[_v("View them when necessary")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("Financial Advisor")]),_v(" "),_c('td',[_v("Delete a client’s record")]),_v(" "),_c('td',[_v("Remove outdated or incorrect information")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Financial Advisor")]),_v(" "),_c('td',[_v("Edit a client’s contact details")]),_v(" "),_c('td',[_v("Update them when necessary")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Financial Advisor")]),_v(" "),_c('td',[_v("Search for a client by name")]),_v(" "),_c('td',[_v("Quickly find their details")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Financial Advisor")]),_v(" "),_c('td',[_v("Sort clients in alphabetical order")]),_v(" "),_c('td',[_v("Quickly find their details")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Financial Advisor")]),_v(" "),_c('td',[_v("Mark client's priority status")]),_v(" "),_c('td',[_v("Quickly identify and attend to high-priority clients")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Financial Advisor")]),_v(" "),_c('td',[_v("Sort client by priority status")]),_v(" "),_c('td',[_v("Quickly identify and attend to high-priority clients")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Financial Advisor")]),_v(" "),_c('td',[_v("Filter clients by location")]),_v(" "),_c('td',[_v("Easily find clients within a specific region")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Financial Advisor")]),_v(" "),_c('td',[_v("Store multiple contact numbers for a client")]),_v(" "),_c('td',[_v("Have alternative ways to reach them")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Financial Advisor")]),_v(" "),_c('td',[_v("Store multiple addresses for a client")]),_v(" "),_c('td',[_v("Keep track of their home and office locations")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Financial Advisor")]),_v(" "),_c('td',[_v("Categorize clients based on communication preferences")]),_v(" "),_c('td',[_v("Contact them in their preferred way")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Financial Advisor")]),_v(" "),_c('td',[_v("Send an email to a client directly from the application")]),_v(" "),_c('td',[_v("Communicate with them efficiently")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Financial Advisor")]),_v(" "),_c('td',[_v("Initiate a phone call to a client from the application")]),_v(" "),_c('td',[_v("Reach them easily")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Financial Advisor")]),_v(" "),_c('td',[_v("Set reminders for following up with clients")]),_v(" "),_c('td',[_v("Not miss important meetings")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Financial Advisor")]),_v(" "),_c('td',[_v("Receive notifications about upcoming meetings")]),_v(" "),_c('td',[_v("Prepare in advance")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Financial Advisor")]),_v(" "),_c('td',[_v("Schedule recurring reminders for periodic check-ins")]),_v(" "),_c('td',[_v("Maintain regular contact")])])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("WealthVault")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("user")]),_v(", unless specified otherwise)")])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"uc01-add-client"}},[_v("UC01 - Add Client"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#uc01-add-client","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User chooses to add a new client.")]),_v(" "),_c('li',[_v("WealthVault requests client details.")]),_v(" "),_c('li',[_v("User enters the required client details.")]),_v(" "),_c('li',[_v("WealthVault verifies the details.")]),_v(" "),_c('li',[_v("WealthVault adds the client to WealthVault and confirms successful addition.")]),_v(" "),_c('li',[_c('strong',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("3a. WealthVault detects an error in the entered details.")])]),_v(" "),_c('ul',[_c('li',[_v("3a1. WealthVault requests for the correct data.")]),_v(" "),_c('li',[_v("3a2. User enters new data.")]),_v(" "),_c('li',[_v("Steps 3a1-3a2 are repeated until the data entered are correct.")]),_v(" "),_c('li',[_c('strong',[_v("Use case resumes from step 4.")])])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("4a. WealthVault detects that the client already exists.")])]),_v(" "),_c('ul',[_c('li',[_v("4a1. WealthVault notifies the user of the duplicate entry.")]),_v(" "),_c('li',[_v("4a2. User chooses to either modify details or cancel the operation.")]),_v(" "),_c('li',[_v("If modifying, "),_c('strong',[_v("use case resumes from step 3.")])]),_v(" "),_c('li',[_v("If canceling, "),_c('strong',[_v("use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("*a. At any time, User chooses to cancel the process.")])]),_v(" "),_c('ul',[_c('li',[_v("*a1. WealthVault requests to confirm the cancellation.")]),_v(" "),_c('li',[_v("*a2. User confirms the cancellation.")]),_v(" "),_c('li',[_c('strong',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"uc02-delete-client"}},[_v("UC02 - Delete Client"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#uc02-delete-client","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("3a. WealthVault detects an error in the entered details.")])]),_v(" "),_c('ul',[_c('li',[_v("3a1. WealthVault requests for the correct data.")]),_v(" "),_c('li',[_v("3a2. User enters new data.")]),_v(" "),_c('li',[_v("Steps 3a1-3a2 are repeated until the data entered are correct.")]),_v(" "),_c('li',[_c('strong',[_v("Use case resumes from step 4.")])])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("3b. The client does not exist in WealthVault.")])]),_v(" "),_c('ul',[_c('li',[_v("3b1. WealthVault notifies the user that the client is not found.")]),_v(" "),_c('li',[_v("3b2. User chooses to either retry or cancel the operation.")]),_v(" "),_c('li',[_v("If retrying, "),_c('strong',[_v("use case resumes from step 2.")])]),_v(" "),_c('li',[_v("If canceling, "),_c('strong',[_v("use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("*a. At any time, User chooses to cancel the process.")])]),_v(" "),_c('ul',[_c('li',[_v("*a1. WealthVault requests to confirm the cancellation.")]),_v(" "),_c('li',[_v("*a2. User confirms the cancellation.")]),_v(" "),_c('li',[_c('strong',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('em',[_v("{More to be added}")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_v("Should work on any "),_c('em',[_v("mainstream OS")]),_v(" as long as it has Java "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("17")]),_v(" or above installed.")]),_v(" "),_c('li',[_v("Should be able to hold up to 1000 clients without a noticeable sluggishness in performance for typical usage.")]),_v(" "),_c('li',[_v("A user with above average typing speed for regular English text (i.e. not code, not system admin commands) should be able to accomplish most of the tasks faster using commands than using the mouse.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('em',[_v("{More to be added}")])])}
},function anonymous(
...
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("API (Application Programming Interface)")]),_v(": A set of protocols and tools that allow different software components to communicate and interact with each other. In the context of WealthVault, it defines how various system components exchange data and functionality.")])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Client")]),_v(": An individual who is a financial advisor’s contact and recipient of financial guidance or services.")])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Financial Advisor")]),_v(": A primary user of the application, responsible for managing client financial data, providing investment advice, and overseeing financial planning.")])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Financial Needs")]),_v(": A client’s specific financial goals or requirements, including investment planning, retirement savings, risk management, and debt reduction strategies.")])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("GUI (Graphical User Interface)")]),_v(": The visual interface of the application that enables users to interact with the system through graphical elements such as buttons, menus, and forms.")])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("PlantUML")]),_v(": A tool used for creating UML (Unified Modeling Language) diagrams, such as sequence diagrams and class diagrams, to document system design and architecture.")])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Private Contact Detail")]),_v(": A contact detail that is not meant to be shared with others.")])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Adding a client while all clients are being shown")]),_v(" "),_c('li',[_v("Prerequisites: List all clients using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command. Multiple clients in the list.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addc n/David Ong p/93012489 e/davidong@example.com a/Block 111 Sengkang Central t/Life Policy")]),_c('br'),_v("\nExpected: New contact is added to the bottom of the list. Details of the added contact shown in the status message.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addc 0")]),_c('br'),_v("\nExpected: No client is added. Error details shown in the status message.")]),_v(" "),_c('li',[_v("Other incorrect addc commands to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addc")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addc x")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("...")]),_c('br'),_v("\nExpected: Similar to previous.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Adding a policy while all clients are being shown")]),_v(" "),_c('li',[_v("Prerequisites: List all clients using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command. Multiple clients in the list.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addp 1 t/Health Insurance")]),_c('br'),_v("\nExpected: \"Health Insurance\" policy is added to the first contact of the list. Details of the added policy shown in the status message.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addp 0")]),_c('br'),_v("\nExpected: No policy is added. Error details shown in the status message.")]),_v(" "),_c('li',[_v("Other incorrect addp commands to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addp")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addp x")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("...")]),_v(" (where x is larger than the list size)"),_c('br'),_v("\nExpected: Similar to previous.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Deleting a client while all clients are being shown")]),_v(" "),_c('li',[_v("Prerequisites: List all clients using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command. Multiple clients in the list.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delc 1")]),_c('br'),_v("\nExpected: First contact is deleted from the list. Details of the deleted contact shown in the status message.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delc 0")]),_c('br'),_v("\nExpected: No client is deleted. Error details shown in the status message.")]),_v(" "),_c('li',[_v("Other incorrect delc commands to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delc")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delc x")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("...")]),_v(" (where x is larger than the list size)"),_c('br'),_v("\nExpected: Similar to previous.")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"deleting-multiple-clients"}},[_v("Deleting multiple clients"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#deleting-multiple-clients","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("Deleting multiple clients while all clients are being shown")]),_v(" "),_c('li',[_v("Prerequisites: List all clients using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command. Multiple clients in the list.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deleteclientmult i/1 i/2")]),_c('br'),_v("\nExpected: First and second contact are deleted from the list. Details of the deleted contacts shown in the status message.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deleteclientmult i/2")]),_c('br'),_v("\nExpected: No client is deleted. Error details shown in the status message.")]),_v(" "),_c('li',[_v("Other incorrect deleteclientmult commands to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deleteclientmult")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deleteclientmult i/1 i/x")]),_v(" (where x is larger than the list size)"),_c('br'),_v("\nExpected: Similar to previous.")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Deleting a policy while all clients are being shown")]),_v(" "),_c('li',[_v("Prerequisites: List all clients using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command. Multiple clients in the list.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delp 1 t/Health Insurance")]),_c('br'),_v("\nExpected: \"Health Insurance\" policy is deleted from the first contact of the list. Details of the deleted policy shown in the status message.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delp 0")]),_c('br'),_v("\nExpected: No policy is deleted. Error details shown in the status message.")]),_v(" "),_c('li',[_v("Other incorrect delp commands to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delp")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delp x")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("...")]),_v(" (where x is larger than the list size)"),_c('br'),_v("\nExpected: Similar to previous.")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"searching-for-clients"}},[_v("Searching for Clients"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#searching-for-clients","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"find-any"}},[_v("Find Any"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#find-any","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("Find a client with any of the keywords matching the tags or names")]),_v(" "),_c('li',[_v("Prerequisites: List all clients using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command. Multiple clients in the list.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("findany Alex Priority")]),_c('br'),_v("\nExpected: Shows all clients with the name or tags matching either (or both) \"Alex\" or \"Priority\" (case-insensitve)")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("findany")]),_c('br'),_v("\nExpected: No client shown. Error details shown in the status message.")])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"find-all"}},[_v("Find All"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#find-all","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("Find a client with any of the keywords matching the tags or names")]),_v(" "),_c('li',[_v("Prerequisites: List all clients using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command. Multiple clients in the list.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("findany Alex friends")]),_c('br'),_v("\nExpected: Shows all clients with the name or tags matching both \"Alex\" or \"friends\" (case-insensitve)")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("findall")]),_c('br'),_v("\nExpected: No client shown. Error details shown in the status message.")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"toggling-priority"}},[_v("Toggling Priority"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#toggling-priority","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("Toggles the priority (as shown by the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Priority")]),_v(" tag) of a client while all clients are being shown")]),_v(" "),_c('li',[_v("Prerequisite 1: Put the jar file in a new folder as the test below is for sample data.")]),_v(" "),_c('li',[_v("Prerequisite 2: List all clients using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command. Multiple clients in the list.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("priority 1")]),_c('br'),_v("\nExpected: First contact (Alex) has a Priority tag added to his card. A success message is shown in the status box.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("priority 1")]),_v(" (again)"),_c('br'),_v("\nExpected: First contact (Alex) has a Priority tag removed from his card. A success message is shown in the status box.")]),_v(" "),_c('li',[_v("Some incorrect commands to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("priority")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("priority x")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("...")]),_v(" (where x is larger than the list size)"),_c('br'),_v("\nExpected: Similar to "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addc")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delc")]),_v(".")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Fri, 2 May 2025, 23:41:25 GMT+8]")])])])}
}];
