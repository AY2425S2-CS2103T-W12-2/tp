...
with(this){return _c('p',[_v("The "),_c('em',[_v("Sequence Diagram")]),_v(" below shows how the components interact with each other for the scenario where the user issues the command "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deleteclient 1")]),_v(".")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deleteclient")]),_v(" command removes a client from the address book based on the specified index.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deleteclient")]),_v(" command deletes a client at a given index. The following sequence diagrams"),_c('br'),_v("\nillustrate how this process flows through the logic component:")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deleteclientmult")]),_v(" command removes multiple clients from the address book based on the specified indices.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deletepolicy")]),_v(" command removes a policy (tag) from a client's list of policies.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("The Class Diagram of a Client can be "),_c('a',{attrs:{"href":"#model-component"}},[_v("seen in the diagram above")]),_v(".")])}
},function anonymous(
...
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("deletepolicy")]),_v(" command deletes a policy at a given index within a displayed policy list."),_c('br'),_v("\nThe following sequence diagrams illustrate how this process flows through the logic component:")])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User chooses to add a new client.")]),_v(" "),_c('li',[_v("WealthVault requests client details.")]),_v(" "),_c('li',[_v("User enters the required client details.")]),_v(" "),_c('li',[_v("WealthVault verifies the details.")]),_v(" "),_c('li',[_v("WealthVault adds the client to the address book and confirms successful addition.\n"),_c('strong',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User chooses to delete a client.")]),_v(" "),_c('li',[_v("WealthVault requests the client’s details for deletion.")]),_v(" "),_c('li',[_v("User enters the required details.")]),_v(" "),_c('li',[_v("WealthVault requests confirmation of the deletion.")]),_v(" "),_c('li',[_v("User confirms the deletion.")]),_v(" "),_c('li',[_v("WealthVault removes the client from the address book and confirms successful deletion.\n"),_c('strong',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Fri, 4 Apr 2025, 12:53:22 GMT+8]")])])])}
}];
