...
public class AddClientCommandParser implements Parser<AddClientCommand> {
    ...
    public AddClientCommand parse(String args) throws ParseException {
        ...
        Name name = ParserClientUtil.parseName(argMultimap.getValue(PREFIX_NAME).get());
        Phone phone = ParserClientUtil.parsePhone(argMultimap.getValue(PREFIX_PHONE).get());
        Email email = ParserClientUtil.parseEmail(argMultimap.getValue(PREFIX_EMAIL).get());
        Address address = ParserClientUtil.parseAddress(argMultimap.getValue(PREFIX_ADDRESS).get());
